...
{
    /// <inheritdoc />
    public partial class CustomAuthInit : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThemePreference = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false, defaultValue: "sprout")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DailyDigestTime = table.Column<TimeSpan>(type: "time(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsSchedulable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ...
                    RepeatInterval = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
